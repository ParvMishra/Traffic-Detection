...
video_path = ''
cap = cv2.VideoCapture("C:/Users/PARV/Desktop/Vehicle-Counting-in-Lanes-main/Vehicle-Counting-in-Lanes-main/oij.mp4")
model = YOLO('yolov8n.pt')

classnames = []
with open('C:\\Users\\PARV\\Desktop\\Vehicle-Counting-in-Lanes-main\\Vehicle-Counting-in-Lanes-main\\classes.txt', 'r') as f:
